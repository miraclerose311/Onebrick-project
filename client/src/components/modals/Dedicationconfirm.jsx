...
const DedicationConfirm = ({ handleSold }) => {
        ...
        <>
            ...
            <div className="flex flex-col items-center bg-yellow-200 drop-shadow-lg w-4/5 h-auto rounded-lg my-2 px-4 py-2">
                <p className='font-raleway text-md my-2'>
                    I dedicate this brick to my {relationship}<br /><span className="text-lg"><b>{name}</b></span>
                </p>
                <div className="w-2/3 rounded-lg my-2 px-4 py-2">
                    {image ? (
                        ...
                        <div className="flex flex-col w-full items-center justify-between gap-y-3">
                            <img class="w-20 h-20 rounded-full" src={user} alt="dedication image"></img>
                        </div>
                    )}
                </div>
                <p className='font-raleway text-md my-2'>
                    Buy this Brick and Save a Life.
                    Click on this box to dedicate your support and help us build a sanctuary of care for those in need
                </p>
            ...
            >
                <span className='flex flex-row items-center justify-between gap-x-3'>CONGRATULATION<FaAnglesRight /></span>
...
export default DedicationConfirm