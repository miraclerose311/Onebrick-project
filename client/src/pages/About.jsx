	...
	return (
		<div className="relative">
			...
			<div className="flex bg-gray-100 flex-col xl:flex-row w-full px-48 pt-28 lg:pr-0">
				...
				<div className="py-36 xl:p-0 z-10 flex justify-end items-center xl:w-2/3">
					{/* <video
						autoPlay
						muted
						loop
			...
			<div className="flex flex-col lg:flex-row w-full px-48 relative">
				<img
					src={Rectangle}
			...
			<div className="flex flex-col w-full bg-gray-300 px-48 justify-center items-center">
				...
				<div className="flex flex-col lg:flex-row lg:gap-12 xl:gap-18 p-12 pb-24 gap-12 items-center w-full">
					<div className="flex flex-col items-center bg-gray-800 text-white h-[400px] justify-evenly px-5">
						...
						<p className="text-xl text-center py-3 font-raleway">
							Contribute directly to our hospice by purchasing a symbolic brick.
							Each brick lays the foundation for a haven of care
						</p>
			...
			<div className="flex flex-col w-full bg-white px-48 justify-center items-center">
			...
			<div className="flex flex-col w-full bg-neutral-700 xl:px-48 lg:px-36 px-24 justify-center items-center relative">
				...
				<div className="flex flex-col lg:flex-row lg:gap-12 xl:gap-18 p-12 gap-12 justify-center items-center w-full">
					<div className="h-[400px] relative">
						<div className="flex flex-col py-8 gap-5 md:w-1/2 lg:w-full items-center bg-neutral-900 text-white justify-evenly px-5">
							<p className="xl:text-2xl text-xl text-gray-300 trncate">
						...
						<div className="absolute top-[330px] right-5 flex gap-1">
							<svg
								id="Layer_1"
								data-name="Layer 1"
			...
			<div className="flex flex-col w-full bg-gray-100 px-48 py-36 justify-center items-center">
				...
				<div className="flex flex-col gap-8 p-24">
					<div className="flex xl:flex-row gap-8 flex-col">
						<div className="flex items-center bg-sky-700 rounded-md">
							<img
								src={AvatarImg}
								className="w-1/2 xl:w-1/3 rounded-md p-3"
							/>
							<div className="flex flex-col ml-4 text-white text-xl">
								<p>LG Kuttukaran</p>
								<p>Dubai, UAE</p>
								<p>5 Bricks I $50,0000</p>
							</div>
						</div>
						<div className="flex items-center bg-sky-700 rounded-md">
							<img
			...
			<div className="flex flex-col xl:flex-row w-full px-48 pt-12 lg:px-0 relative">
				<div className="absolute w-5/6 right-36 top-36 h-3/4 bg-gray-200"></div>
				<div className="xl:px-0 px-36 pt-24 xl:py-12 xl:w-1/3 w-full z-10">
					<img
						src={Image2}
						className="w-full xl:object-cover object-fill"
					/>
				</div>
				<div className="py-16 xl:px-12 z-10 flex flex-col xl:w-2/3">
					...
					<div className="flex flex-col pr-56 gap-3 py-8">
						<Collapse
