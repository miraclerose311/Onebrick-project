          ...
          <div className="p-5 2xl:p-10 w-full md:w-3/4 lg:w-1/3">
            <div className=" bg-gray-800 text-white flex flex-col gap-8 rounded-md items-center p-5 lg:p-5 lg:px-8 xl:py-12 h-full">
              ...
              <EditableParagraph
                ...
                onBlur={onBlur}
                className="text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold text-center w-full font-montserra"
              />
              <EditableParagraph
                name="HomeText10"
                content={
          ...
          <div className="p-5 2xl:p-10 w-full md:w-3/4 lg:w-1/3">
            <div className="bg-white flex flex-col gap-8 rounded-md items-center p-5 lg:p-5 lg:px-8 xl:py-12 h-full">
              ...
              <EditableParagraph
                ...
                onBlur={onBlur}
                className="overflow-clip text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold text-center w-full font-montserra text-sky-700"
              />
              <EditableParagraph
                name="HomeText12"
                content={
